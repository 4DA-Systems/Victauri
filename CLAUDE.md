...
cargo test --workspace                                # Run all 1813 Rust tests
...
- **victauri-plugin**: Full MCP server with **28 tools** + 3 resources. Tools organized by category:
...
- **CLAUDE.md scaffolding** — `victauri init` creates/appends CLAUDE.md with instructions that make AI agents prefer Victauri's 28 MCP tools over CDP/Playwright. This is the highest-leverage fix for agent tool selection — agents read CLAUDE.md before choosing tools.
